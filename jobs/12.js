...
alterState(state => {
  ...
  state.fieldSets = [
    ...
    makeSet(
      'sex',
      'ampi__Picklist_Response__c',
      'form.structures_locales.violence_sexuelles.details_cas_violence_sexuelles.gender'
    ),
    makeSet(
      'count if female',
      'ampi__Number_Response__c',
      'form.structures_locales.violence_sexuelles.details_cas_violence_sexuelles.count_if_female'
    ),
    makeSet(
      'count if male',
      'ampi__Number_Response__c',
      'form.structures_locales.violence_sexuelles.details_cas_violence_sexuelles.count_if_male'
    ),
    makeSet(
